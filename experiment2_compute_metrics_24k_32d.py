...
from external.AcademiCodec.Encodec_24k_32d.net3 import SoundStream
...
def get_parser():
    ...
    parser.add_argument('--samplerate', type=int, default=24000)
    parser.add_argument('--target_bw', type=float, default=7.5)
    parser.add_argument('--ratios', type=int, nargs='+', default=[2, 2, 2, 4], help='List of ratios')
